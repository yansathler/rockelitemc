    ...
    <main className="min-h-screen bg-zinc-950 p-6 text-zinc-100 md:p-10">
      ...
      <div className="mb-8 flex flex-col justify-between gap-4 border-b border-zinc-900 pb-6 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => carregarEstoque()} className="flex items-center gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2 text-xs font-bold uppercase text-zinc-400 hover:bg-zinc-800 transition-colors">
            🔄 Recarregar
          </button>
          <button onClick={() => setModalProdutoAberto(true)} className="rounded-lg bg-white px-5 py-2 text-xs font-black uppercase text-zinc-950 hover:bg-zinc-200 transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)]">
            ➕ Novo Produto
          </button>
        </div>
      </div>
